...
exports.createCommande = (req, res) => {
  ...
  connection.query(
    client.getClientPointFideliteCommande,
    [id_user],
    (error, result) => {
      if (
        ...
        if (error) {
          res
            ...
            .json({
              error: error,
              message: HttpRequestMessagesUser.errorGetClientById,
            });
        } else {
          connection.query(
            ...
            (error, result) => {
              if (error) {
                res
                  ...
                  .json({
                    error: error,
                    message: httpRequestMessagesCommande.errorCreateCommande,
                  });
              } else {
                connection.query(
                  client.UpdatePointFidelite,
                  [bonus, visit, statusFidelite, id_user],
                  (error, result) => {
                    if (error) {
                      res
                        .status(400)
                        .json({
                          error: error,
                          message:
                            HttpRequestMessagesUser.errorUpdatePointFidelite,
                        });
                    } else {
                      res.status(200).json;
                    }
                ...
                res
                  ...
                  .json({
                    result: result,
                    message: httpRequestMessagesCommande.successCreateCommande,
                  });
              }
            }
          );
        ...
        if (
          totalBonus > VALUE_MIN_SILVER &&
          pointFideliteExist < VALUE_MAX_SILVER
        ) {
  ...
  connection.query(commande.getCommandeById, [id_commande], (error, result) => {
    if (result < 1) {
      res
        ...
        .json({
          error: error,
          message: httpRequestMessagesCommande.errorGetCommandById,
        });
    } else {
      res
        .status(201)
        .json({
          result: result,
          message: httpRequestMessagesCommande.successGetCommandById,
        });
    }
  });
};
  ...
  connection.query(commande.getCommandeByVille, [ville], (error, result) => {
    if (result.length < 1) {
      res
        ...
        .json({
          error: error,
          message: httpRequestMessagesCommande.errorGetCommandByVille,
        });
    } else {
      res
        .status(201)
        .json({
          result: result,
          message: httpRequestMessagesCommande.successGetCommandByVille,
        });
    }
  });
};
exports.getCommandByVilleAndIdBoutique = (req, res) => {
  ...
  connection.query(
    commande.getCommandeByVilleAndIdBoutique,
    [ville, idBoutique],
    (error, result) => {
      if (result < 1) {
        res
          ...
          .json({
            error: error,
            message:
              httpRequestMessagesCommande.errorGetCommandByVilleAndIdBoutique,
          });
      } else {
        res
          .status(201)
          .json({
            result: result,
            message:
              httpRequestMessagesCommande.successGetCommandByVilleAndIdBoutique,
          });
      }
    }
  );
...
exports.getCommandByIdBoutique = (req, res) => {
  ...
  connection.query(
    commande.getCommandeByIdBoutique,
    [idBoutique],
    (error, result) => {
      if (result < 1) {
        res
          ...
          .json({
            error: error,
            message: httpRequestMessagesCommande.errorGetCommandByIdBoutique,
          });
      } else {
        res
          .status(201)
          .json({
            result: result,
            message: httpRequestMessagesCommande.successGetCommandByIdBoutique,
          });
      }
    }
  );
...
exports.getCommandByIdBoutiqueAndNumeroCommand = (req, res) => {
  ...
  connection.query(
    commande.getCommandeByIdBoutiqueAndNumeroCommande,
    [idBoutique, numeroCommande],
    (error, result) => {
      if (result < 1) {
        res
          .status(400)
          .json({
            error: error,
            message:
              httpRequestMessagesCommande.errorGetCommandByIdBoutiqueAndNumeroCommande,
          });
      } else {
        res
          .status(201)
          .json({
            result: result,
            message:
              httpRequestMessagesCommande.successGetCommandByIdBoutiqueAndNumeroCommande,
          });
      }
    }
  );
    ...
    (error, result) => {
      if (result.length < 1) {
        res
          ...
          .json({
            error: error,
            message: httpRequestMessagesCommande.getCommandNull,
          });
      } else {
        res
          .status(201)
          .json({
            result: result,
            message:
              httpRequestMessagesCommande.successGetCommandByNumeroClient,
          });
      }
    }
  );
...
exports.getCommandByNumeroCommande = (req, res) => {
  ...
  connection.query(
    commande.getCommandeByNumeroCommande,
    [numeroCommande, idBoutique],
    (error, result) => {
      if (result < 1) {
        res
          .status(400)
          .json({
            error: error,
            message: httpRequestMessagesCommande.getAllCommandNull,
          });
      } else {
        res
          .status(201)
          .json({
            result: result,
            message:
              httpRequestMessagesCommande.successGetCommandByNumeroCommande,
          });
      }
    }
  );
  ...
  connection.query(commande.getCommandeByPhone, [phone], (error, result) => {
    if (result < 1) {
      res
        ...
        .json({
          error: error,
          message: httpRequestMessagesCommande.errorGetCommandByTelephone,
        });
    } else {
      res
        .status(201)
        .json({
          result: result,
          message: httpRequestMessagesCommande.successGetCommandByTelephone,
        });
    }
  });
};
...
exports.getCommandByDateCommande = (req, res) => {
  ...
  connection.query(
    commande.getCommandeByDateCommande,
    [dateCommande],
    (error, result) => {
      if (result < 1) {
        res
          ...
          .json({
            error: error,
            message: httpRequestMessagesCommande.errorGetCommandByDateCommande,
          });
      } else {
        res
          .status(201)
          .json({
            result: result,
            message:
              httpRequestMessagesCommande.successGetCommandByDateCommande,
          });
      }
    }
  );
  ...
  connection.query(commande.getAllCommandes, (error, result) => {
    if (error) {
      res
        ...
        .json({
          error: error,
          message: httpRequestMessagesCommande.errorGetAllCommand,
        });
    } else {
      if (result.length < 1) {
        res
        ...
        res
          ...
          .json({
            result: result,
            message: httpRequestMessagesCommande.successGetAllCommand,
          });
      }
    }
  });
...
exports.updateCommandeByCritere = (req, res) => {
  ...
  if (id_commande != undefined) {
    connection.query(
      commande.getCommandeById,
      [id_commande],
      (error, result) => {
        if (result.length > 0) {
          const { livraison, prixTotal, patisseriesList, dateCommande } =
            req.body;
          const { numeroCommande, id_user, idBoutique } = result[0];
          connection.query(
            commande.updateCommandeByIdCommande,
            [
              dateCommande,
              numeroCommande,
              id_user,
              ...
              if (
                ...
                res
                  ...
                  .json({
                    results: results,
                    message:
                      httpRequestMessagesCommande.successUpdateCommandeByCriteres,
                  });
              } else {
                res
                  .status(400)
                  .json({
                    error: error,
                    message:
                      httpRequestMessagesCommande.errorUpdateCommandeByCritere,
                  });
              }
            }
          );
          ...
          res
            ...
            .json({
              error: error,
              message: httpRequestMessagesCommande.errorGetCommandByCritere,
            });
        }
      }
    );
    ...
    connection.query(
      ...
      (error, result) => {
        if (result.length > 0) {
          ...
          connection.query(
            commande.updateCommandeByNumeroCommande,
            [
              dateCommande,
              id_commande,
              id_user,
          ...
          res
            ...
            .json({
              error: error,
              message:
                httpRequestMessagesCommande.errorGetCommandByNumeroCommande,
            });
        }
      }
    );
  ...
  connection.query(commande.deleteCommande, [id_commande], (error, result) => {
    if (result.affectedRows === 0) {
      res
        ...
        .json({
          error: error,
          message: httpRequestMessagesCommande.errorDeleteCommande,
        });
    } else {
      res
        .status(201)
        .json({ message: httpRequestMessagesCommande.successDeleteCommande });
    }
  });
};
