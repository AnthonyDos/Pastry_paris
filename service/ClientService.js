...
exports.getClientPointFideliteCommande = 'SELECT users.pointFidelite,users.numero_passage,users.statusFidelite,commandes.pointReservation, commandes.numeroPassage FROM users INNER JOIN commandes ON users.id_user = commandes.id_user  WHERE users.id_user= ?'
exports.getClientPointFideliteReservation = 'SELECT users.pointFidelite,users.numero_passage,users.statusFidelite,reservation.pointReservation, reservation.numeroPassage FROM users INNER JOIN reservation ON users.id_user = reservation.id_user  WHERE users.id_user= ?'
