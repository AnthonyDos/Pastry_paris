...
exports.getClientPointFideliteCommande = 'SELECT users.pointFidelite,users.numero_passage,commandes.pointReservation, commandes.numeroPassage FROM users INNER JOIN commandes ON users.id_user = commandes.id_user  WHERE users.id_user= ?'
exports.getClientPointFideliteReservation = 'SELECT users.pointFidelite,users.numero_passage,reservation.pointReservation, reservation.numeroPassage FROM users INNER JOIN reservation ON users.id_user = reservation.id_user  WHERE users.id_user= ?'
...
exports.UpdatePointFidelite = "UPDATE users SET pointFidelite= ?, numero_passage= ? WHERE id_user= ?"
