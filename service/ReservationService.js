...
exports.createDateResa =
  "INSERT INTO dateresa SET dateResa= ?, couvertsDate= ?, idBoutique= ?";
...
exports.updateDateResa =
  "UPDATE dateresa SET dateresa.couvertsDate= ? WHERE dateResa= ?";

//get place dispo
exports.getPlace =
  "SELECT placeDispo FROM reservation WHERE dateReservation= ?";
exports.updatePlace =
  "UPDATE reservation SET reservation.placeDispo= ? WHERE dateReservation= ? ";
...
exports.getReservationByNumeroReservation =
  "SELECT * FROM reservation WHERE numeroReservation= ?";
...
//suppression
exports.deleteReservationByIdReservation =
  "DELETE FROM reservation WHERE id_reservation= ?";
exports.deleteReservationByNumeroReservation =
